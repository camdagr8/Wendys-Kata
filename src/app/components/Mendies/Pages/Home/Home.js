            ...
            <Template title={title} className={className}>
                <main className={'main-content'} role='main'>
                    <div className={'main-content-left'}>
                        ...
                        <p className={'mt-xs-20'}>Only the pure of heart can make a superb burger.</p>
                        <NavLink to={'/categories'} className={'btn-primary-lg-pill mt-xs-20 mt-md-40 hide-xs-only'}>
                            Order Online
                        </NavLink>
                    </div>
